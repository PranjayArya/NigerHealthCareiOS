//
//  CompleteMedicineListController.swift
//  NigerHealthCare
//
...
class CompleteMedicineListController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        tvMedicineNameTableview.registerNib(MedicineSearchTableViewCell.nameOfClass)
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == SegueIdentifiers.mListToMDetails{
...
extension CompleteMedicineListController:UITextFieldDelegate{
...
extension CompleteMedicineListController:UITableViewDataSource,UITableViewDelegate{
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        self.performSegue(withIdentifier: SegueIdentifiers.mListToMDetails, sender: nil)
    }
}
