...
class MedicineNameController: UIViewController {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == SegueIdentifiers.mNameToMDetails{
...
extension MedicineNameController:UITextFieldDelegate{
...
extension MedicineNameController:UITableViewDataSource,UITableViewDelegate{
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        self.performSegue(withIdentifier: SegueIdentifiers.mNameToMDetails, sender: nil)
    }
}
